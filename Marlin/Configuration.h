...
#define CUSTOM_MACHINE_NAME "Ldsw I3"////////////add/modify by wyl
...
#define PREVENT_COLD_EXTRUSION ////////////add/modify by wyl
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*60)////////////add/modify by wyl
#define HOMING_FEEDRATE_Z  (4*60)////////////add/modify by wyl


// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {800,800,3200,880}  // default steps per unit for Ultimaker
...
#define DEFAULT_XJERK                20.0    // (mm/sec)////////////add/modify by wyl (old:DEFAULT_XYJERK)
#define DEFAULT_YJERK                20.0    // (mm/sec)////////////add/modify by wyl(old:DEFAULT_XYJERK)
